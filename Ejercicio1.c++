/* Realice un programa que genere la venta de de compra de un terreno/casa/departamento. Este programa debe realizar c?lculos de acuerdo con la 
...
void ingresar(){
	...
	do{
		system("CLS");
		cout<<"Seleccione el tipo de categor?a a ingresar"<<endl;
